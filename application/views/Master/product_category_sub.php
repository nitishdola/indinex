              ...
              <div class="panel">
                <figure class="overlay overlay-hover animation-hover">
                  ...
                  <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                    ...
                    <a href="<?php echo site_url('Masters/create_category');?>" class="btn btn-inverse project-button">CREATE</a>
                  </figcaption>
                </figure>
                ...
                <figure class="overlay overlay-hover animation-hover">
                  ...
                  <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                    <div class="btn-group">
                     ...
                     <a href="<?php echo site_url('Masters/change_category');?>" class="btn btn-inverse project-button">CHANGE</a>
                ...
                <figure class="overlay overlay-hover animation-hover">
                  ...
                  <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                    <div class="btn-group">
                     ...
                     <a href="<?php echo site_url('Masters/display_category');?>" class="btn btn-inverse project-button">DISPLAY</a>                    
                  </figcaption>
                </figure>
