...
<body class="animsition app-projects">
   <?php $this->load->view('layout/admin/nav_menu'); ?>
    <?php $company_id= $this->input->get('id');?>
    <div class="page">
                      ...
                      <div class="example-wrap">
                        <h4 class="example-title">Change Company</h4> 
                         ...
                         <?php foreach($res as $r) { ?>   
                          <div class="example">                    
                               <?php echo form_input(array('type' =>'hidden', 'name' => 'company_id','id'=>'company_id','value'=>$company_id)); ?>                 
                            <div class="form-group row">
                              <label class="col-md-4 col-form-label">Company Code: </label>
                              <div class="col-md-8">
                               <?php echo form_input(array('type' =>'number', 'name' => 'company_code','id'=>'','class'=>'form-control','style'=>'margin-bottom:5px','required'=>'true','autocomplete'=>'off','readonly'=>'true','value'=>str_pad($r->company_code, 4, '0', STR_PAD_LEFT))); ?><span><p  id="code_div" style="color:red;display:none">Code already exist</p></span>
                              </div>
                            </div> 
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-8">
                              <?php echo form_input(array('type' =>'text', 'name' => 'company_name','id'=>'company_name','class'=>'form-control','style'=>'margin-bottom:5px','required'=>'true','autocomplete'=>'off','value'=>$r->company_name)); ?>
                              </div>
                            </div>  
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-8">
                                <?php echo form_input(array('type' => 'text','id' => 'company_name2', 'name' => 'company_name2','class'=>'form-control','style'=>'margin-bottom:5px','autocomplete'=>'false','value'=>$r->company_name2)); ?>
                              </div>
                            </div>     <div class="form-group row">
                              <label class="col-md-4 col-form-label" ></label>
                              <div class="col-md-8">
                                <?php echo form_input(array('type' => 'text','id' => 'company_name3', 'name' => 'company_name3','class'=>'form-control','style'=>'margin-bottom:5px','autocomplete'=>'false','value'=>$r->company_name3)); ?>
                              </div>
                            </div>  
                     ...
                     <h4 class="example-title">Communication</h4> 
                      <div class="form-group row">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-8">
                                <?php echo form_input(array('type' => 'text','id' => 'fax', 'name' => 'fax','class'=>'form-control','style'=>'margin-bottom:5px','autocomplete'=>'false','maxlength'=>'10','value'=>$r->fax)); ?>
                              </div>
                            </div>
                        <div class="form-group row">
