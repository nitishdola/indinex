                ...
                <div class="example-wrap">
                  <div class="example">
                    ...
                    <table class="table table-bordered table-hover">
                      ...
                      <tr>
                        <th width="25%">Customer Code: </th><td width="25%"><?php echo str_pad($row->customer_code, 4, '0', STR_PAD_LEFT);?></td>
                      </tr>
                       <tr>
                        <th width="25%">Customer Name: </th><td width="25%"><?php echo $row->title;?>&nbsp;<?php echo $row->first_name;?>&nbsp;<?php echo $row->middle_name;?>&nbsp;<?php echo $row->last_name;?></td><th width="25%">Country : </th><td width="25%"><?php echo $row->country;?></td>
                      </tr>
                       <tr>
                        <th width="25%">Mobile : </th><td width="25%"><?php echo $row->mobile?></td><th width="25%">Region: </th><td width="25%"><?php echo $row->name?></td>
                      </tr>
                       <tr>
