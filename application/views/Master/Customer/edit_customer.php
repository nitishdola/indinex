          ...
          <div class="panel">
            ...
            <?php echo form_input(array('type' =>'hidden', 'name' => 'customer_id','id'=>'customer_id','value'=>$customer_id)); ?>
                   ...
                   <div class="col-md-12">
                    <div class="form-group row">
                      <div class="col-md-9">
                        <?php echo form_input(array('type' =>'hidden', 'name' => 'vendor_id','id'=>'vendor_id','value'=>$customer_id)); ?>
...
$(function(){
  ...
  $('#region_id,#region_bank_id').change(function(){
    var region_id       =$('#region_id').val();
    var region_bank_id  =$('#region_bank_id').val();
    ...
    //$('#loc_storage_from,#loc_storage_to').empty().append('<option value=" ">Select</option>');       
      var url= "<?php echo base_url(); ?>" + "index.php/Masters/ajax_get_cities";       
        jQuery.ajax({
          ...
          url: url,
          dataType: 'json',
          data: {region_id: region_id,region_bank_id: region_bank_id},
          success: function (jsonArray) {      
              $.each(jsonArray, function(index,jsonObject){
                  $('#city_id,#city_bank_id')
