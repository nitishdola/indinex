                  ...
                  <div class="row row-lg">
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                      ...
                      <div class="example-wrap">
                        <h4 class="example-title">General Data</h4> 
                        ...
                        <div class="example">                    
                            <div class="form-group row">
                              ...
                              <div class="col-md-8">
                              <?php echo form_input(array('type' =>'text', 'name' => 'vendor_code','id'=>'vendor_code','class'=>'form-control','style'=>'margin-bottom:5px','required'=>'true','autocomplete'=>'off','readonly'=>'readonly','value'=>$vendor_group_id)); ?>
                              </div>
                            </div>                      
                            <div class="form-group row">
