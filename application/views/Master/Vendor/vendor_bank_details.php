                  ...
                  <div class="row row-lg">
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                      ...
                      <div class="example-wrap">
                        <h4 class="example-title">Bank Details</h4> 
                        ...
                        <div class="example"> 
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-8">
                              <?php echo form_input(array('type' => 'text','id' => 'bank_name', 'name' =>'bank_name','class'=>'form-control','style'=>'margin-bottom:5px','required'=>'true','autocomplete'=>'false','maxlength'=>'10')); ?>
                              </div>
                            </div>                                       
                        </div>
                      </div>                     
