              ...
              <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                ...
                <div class="example-wrap">
                  ...
                  <div class="example">                    
                    ...
                    <tr>
                     <th>Sl</th><th>Vendor Account Group</th><th>Type of Business</th><th>Vendor Name</th><th>Vendor Code</th><th>Company Code</th><th>Change</th>
                    </tr>                    
                    <tbody>
                    <?php 
                    $i=0;                           
                    ...
                    { $i++;?>
                      <tr>  
                        ...
                        <td><a href="<?php echo site_url('vendors/edit_vendor?id='.$row->vendor_id);?>" class="btn btn-info btn-sm"  style="margin: 5px">Change</a>
                        </td>
                      </tr>  
                     <?php }  ?>
