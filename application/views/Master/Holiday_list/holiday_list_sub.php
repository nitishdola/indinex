    ...
    <div class="page">
              ...
              <div class="panel">
                <figure class="overlay overlay-hover animation-hover">
                  ...
                  <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                    ...
                    <a href="<?php echo site_url('Masters/create_holiday_list');?>" class="btn btn-inverse project-button">CREATE</a>
                  </figcaption>
                </figure>
      ...
      <li>
                ...
                <figure class="overlay overlay-hover animation-hover">
                  ...
                  <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                    <div class="btn-group">
                     ...
                     <a href="<?php echo site_url('Masters/change_holiday_list');?>" class="btn btn-inverse project-button">CHANGE</a>
          ...
          <div class="dropdown float-left">
                     ...
                     <a href="<?php echo site_url('Masters/display_holiday_list');?>" class="btn btn-inverse project-button">DISPLAY</a>                    
                  </figcaption>
                </figure>
