            ...
            <div class="row row-lg">
              <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                ...
                <div class="example-wrap">
                  <h4 class="example-title">Create Holiday List</h4>  
                  ...
                  <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <?php echo form_input(array('type' => 'text', 'name' => 'date_from','class'=>'form-control zdatepicker','style'=>'margin-bottom:5px','required'=>'true','autocomplete'=>'off')); ?>
                        </div>
                      </div> 
                      <div class="form-group row">
                        <label class="col-md-3 col-form-label">Date To</label>
                        <div class="col-md-9">
                          <?php echo form_input(array('type' => 'text', 'name' => 'date_to','class'=>'form-control zdatepicker','style'=>'margin-bottom:5px','autocomplete'=>'off')); ?>
                        </div>
                      </div>                        
