      ...
      <div class="page-content">
        ...
        <div class="projects-wrap">
              ...
              <div class="panel">
                <figure class="overlay overlay-hover animation-hover">
                  ...
                  <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                    ...
                    <a href="<?php echo site_url('Masters/create_vendor');?>" class="btn btn-inverse project-button">CREATE</a>
                  </figcaption>
                </figure>
                ...
                <figure class="overlay overlay-hover animation-hover">
                  ...
                  <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                    <div class="btn-group">
                     ...
                     <a href="<?php echo site_url('Masters/change_vendor');?>" class="btn btn-inverse project-button">CHANGE</a>
          ...
          <div class="dropdown float-left">
                     ...
                     <a href="<?php echo site_url('Master/display_vendor');?>" class="btn btn-inverse project-button">DISPLAY</a>                    
                  </figcaption>
                </figure>
