      ...
      <div class="col-sm-8">
        <form method="post" action="" autocomplete="off"> 
            ...
            <h2>Create Product Variants</h2>
              ...
              <p><b>Product Variants</b></p>
                <div class="row">
                  ...
                  <div class="col-75">                   
                    <?php echo form_input(array('id' => 'ccode', 'name' => 'pvcode','class'=>'form-control','style'=>'margin-bottom:5px','required'=>'true','style'=>'width:60px','maxlength'=>'4','autocomplete'=>'off')); ?>
                  </div>
                </div>
                <div class="row">
                  <div class="col-25">
                    <label for="fname">Variants Type</label>
                  </div>
                  <div class="col-75">
                ...
                <div class="row">
                  <div class="col-25">
                    <label for="fname">Variants Name</label>
                  </div>
                  <div class="col-75">
          ...
          <div id="div_display" style="display:none">           
              ...
              <table border="1" width="100%">
                <tr>
                  <th>Sl</th><th>Code</th><th>Variants Types</th><th>Variants Name</th>
                </tr>
                <tbody>
                  <?php 
                    $i=0;                           
