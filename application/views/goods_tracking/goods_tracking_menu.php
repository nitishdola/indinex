   ...
   <?php $this->load->view('layout/admin/nav_menu'); ?>
    ...
    <div class="page">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Goods Tracking</li>
      </ol>
              ...
              <div class="panel">
                <figure class="overlay overlay-hover animation-hover">
                  ...
                  <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                    ...
                    <a href="<?php echo site_url('goods_tracking/create_goods_tracking');?>" class="btn btn-inverse project-button">CREATE</a>
                  </figcaption>
                </figure>
                ...
                <figure class="overlay overlay-hover animation-hover">
                  ...
                  <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                    <div class="btn-group">
                     ...
                     <a href="<?php echo site_url('goods_tracking/change_goods_tracking');?>" class="btn btn-inverse project-button">CHANGE</a>
