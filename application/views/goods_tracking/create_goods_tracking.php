                      ...
                      <tr>
                          ...
                          <?php $i=0;
                            ...
                            <tr>  
                              ...
                              <td><?php echo $row->first_name.'&nbsp;'.$row->middle_name.'&nbsp'.$row->last_name;?></td>
                              ...
                              <td align="center">
                                <?php if($status==1) {
                                  ...
                                  <button type="button" class="btn btn-success btn-sm"  style="margin: 5px" data-toggle="modal" data-target="#statusModal" data-id="<?php echo $purchase_order_id; ?>">On the Way</button>
                              ...
                              <td>
                              <?php if($status==1) { ?>
                                  <!--<button type="button" class="btn btn-info btn-sm"  style="margin: 5px" data-toggle="modal" data-target="#myModal" data-id="<?php //echo $purchase_order_id; ?>" >Add Consignment No</button>-->
                                <a href="<?php echo site_url('goods_tracking/add_consignement_number?id='.$purchase_order_id);?>" class="btn btn-info btn-sm"  style="margin: 5px">Add Consignment No</a>
                                <?php } else { 
                                    echo $row->consignment_no;
                                } ?>
                            </tr>  
                          <?php }  ?>
                        </table>
