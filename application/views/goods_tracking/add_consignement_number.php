  ...
  <?php $purchase_order_id= str_pad($_GET['id'], 4, '0', STR_PAD_LEFT);?>
      ...
      <ol class="breadcrumb">
       <li class="breadcrumb-item"><a href="<?php echo site_url('dashboard/');?>">Home</a></li>
        ...
        <li class="breadcrumb-item active"><a href="<?php echo site_url('goods_tracking/create_goods_tracking');?>">Create Tracking</a></li>
        <li class="breadcrumb-item active">Add Consignment Number</li>
      </ol>
