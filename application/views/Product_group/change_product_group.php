            ...
            <div class="panel-body container-fluid">
              ...
              <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                ...
                <div class="example-wrap">
                  <h4 class="example-title">Change Product Group</h4>                  
                  <div class="example">  
                  <?php if(!empty($result->result()))  { ?>                  
                      <table class="table table-hover data-table table-striped table-bordered w-full">
                    <thead>
                      <tr>
                       <th>Sl</th><th>Group Code</th><th>Group Name</th><th>Edit</th><th>Delete</th>
                      </tr>
                      </thead>
                      <tbody>
                        <?php 
                          ...
                          <tr>  
                            ...
                            <td><a href="<?php echo site_url('Masters/edit_product_group?id='.$row->id);?>" class="btn btn-info btn-sm"  style="margin: 5px">Edit</a></td>
