      ...
      <div class="page-content">
        ...
        <div class="projects-wrap">
                ...
                <figure class="overlay overlay-hover animation-hover">
                  ...
                  <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                    <div class="btn-group">
                     ...
                     <a href="<?php echo site_url('grn/view_all_grns');?>" class="btn btn-inverse project-button">CHANGE</a>
          ...
          <div class="dropdown float-left">
                    ...
                    <button type="button" class="btn btn-inverse project-button">
                    <a title="CREATE" class="dashboard-links" href="<?php echo site_url('grn/view_all_grns'); ?>">DISPLAY</a></button>
                  </figcaption>
                </figure>
                <div class="text-truncate"><a class="dashboard-links" href="<?php echo site_url('grn/view_all_grns'); ?>">DISPLAY</a></div>
              </div>
            </li>
